...
jsPsych.plugins['mrst-instructions'] = (function() {
      ...
      pages: {
        ...
        nested: {
          ...
          stimulus: {
            ...
            default: './static/img/all_animals/rabbit-shape.svg',
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      ...
      console.log(trial.pages[current_page].audio)
...
if (current_page > -1) {
  ...
  .catch(function(err){
    console.error('Audio file failed to load')
     ...
     // jsPsych.pluginAPI.getAudioBuffer('./static/audio/Risk_1__intro.mp3')
  //.then(function(audio){
//    audio.play();
  //})
     // var audio = jsPsych.pluginAPI.getAudioBuffer(['./static/audio/Risk_1__intro.mp3']);
      //var audio = new Audio('./static/audio/Risk_1__intro.mp3');
     //audio.currentTime = 0;
     //audio.play();
    ...
    nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn' disabled='true' style='margin-left: 5px;'>"  + trial.button_label_next + " &gt;</button></div>";
      html += nav_html;
           
            console.log('view_duration', trial.pages[current_page].view_duration)
...
//view_duration
      ...
      // if (current_page != 0) { setTimeout(function(){ document.getElementById('jspsych-instructions-next').disabled=false}, 5000)
     ...
     // display_element.querySelector('#jspsych-instructions-next').addEventListener('click', btnListener);
     //setTimeout(function(){ display_element.querySelector('#jspsych-instructions-next').addEventListener('click', btnListener).disabled=false}, trial.pages[current_page].view_duration);
    ...
    var after_response = function(info) {
      ...
      keyboard_listener = jsPsych.pluginAPI.getKeyboardResponse({
        ...
        valid_responses: [trial.key_backward],//[trial.key_forward, trial.key_backward],
