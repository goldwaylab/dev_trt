...
jsPsych.plugins["audio-test"] = (function() {
	...
	plugin.info = {
      ...
      prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Prompt',
        default: '<br>If you are unable to hear the word, follow the approved study instructions for stopping or contacting the study team.',
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // display stimulus
    var html = '<div id="jspsych-html-button-response-stimulus">In order to complete this task, you will need to have your computer audio on. If you do not have computer audio, follow the approved study instructions for stopping or contacting the study team.<br><br>We will now test your audio. When you press the button below, you will hear a word being spoken.<br><br>On the following screen, we will ask you to tell us what word you heard. This allows us to verify that your audio is working. </div>';
    ...
    function check_response(){
      ...
      if (input_val.toUpperCase().trim() === trial.correct_responses[audio_ix].toUpperCase()){
        ...
        alert('Sorry, that response is incorrect. Please try again or follow the approved study instructions for stopping the task.')
      }
