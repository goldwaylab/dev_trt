...
* For settings, see two-step-settings.js . They should be descriptively named and you can search for their use.
...
Based on the original “MBMF_200trials” Matlab implementation.
